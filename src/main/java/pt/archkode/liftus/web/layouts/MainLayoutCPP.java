...
public class MainLayoutCPP extends VerticalLayout implements RouterLayout {
    private Div contentArea;

    public MainLayoutCPP(AuthenticatedUser authenticatedUser) {
        setWidthFull();
        setPadding(false);
        setSpacing(false);
        ...
        //System.out.println(authenticatedUser.get().get().toString());
    }
